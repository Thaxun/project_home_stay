...
<script>
    $(document).ready(function(){
        ...
        $("#ren_number").change(function(){
            let ren_id = $("#ren_number").val();
            $.post("get_price.php",{
                ren_id : ren_id
            },function(data){
                $("#status_price").html(data)
            })
        })
    })
</script>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-primary text-center">
                        <h4><i class="fa fa-id-card"></i> ຟອມບັນທືກຂໍ້ມູນຜູ້ເຂົ້າພັກ</h4>
                    </div>
                    <div class="card-body">
                        <form action="">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                            ...
                                            <select name="" id="status_price" class="form-select">
