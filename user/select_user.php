    ...
    <div class="container-fluid">
        ...
        <table class="table table-bordered  border-primary">
                ...
                <tr>
                    ...
                    <td width="9%"><?php echo $row['username']; ?></td>
                    <td width="10%"> <?php echo $row['vill_now']; ?></td>
                    <td ><a href="edit_pass.php?u_id=<?php echo $row['u_id']; ?>" style="font-size:13px;" class="btn btn-primary">ປ່ຽນລະຫັດຜ່ານ</a></td>
                    <td width="17%">
                        <a href="edit_user.php?u_id=<?php echo $row['u_id']; ?>" class="btn btn-warning"><i class="fa fa-edit"></i> ແກ້ໄຂ</a>
                        <a href="delete_user.php?u_id=<?php echo $row['u_id']; ?>" class="btn btn-danger delete"><i class="fa fa-trash"></i> ລົບ</a>
                    </td>
                </tr>
                <?php }?>
        </table>
