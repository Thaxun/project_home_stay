...
<head>
  ...
  <title>ລະບົບບໍລິຫານ ເຮືອນພັກ</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="home_user.php" target="frame" class="nav-link">ໜ້າຫຼັກ</a>
      </li>
  ...
  <div class="content-wrapper">
	...
	<iframe width="100%" height="100%" frameborder="0" name="frame" src="home_user.php"></iframe>
