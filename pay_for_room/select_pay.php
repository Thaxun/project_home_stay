<?php 
    ...
    $order = 1;
    $select_curdate = mysqli_query($conn,"SELECT curdate()");
    $date = mysqli_fetch_array($select_curdate);
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="container">
        <div class="card-header bg-primary text-center">
            <h4><i class="fa-solid fa-money-bill"></i> ລາຍການລໍຖ້າຊຳລະເງິນ</h4>
        </div>
        <table class="table table-hover table-striped table-bordered" id="mytable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a href="form_pay.php?i_id=<?php echo $row['i_id']; ?>" class="btn btn-info"><i class="fa fa-edit"></i> ຈ່າຍ</a>
                    </td>
                </tr>
                <?php }?>
            </tbody>
